...
ham_train = np.count_nonzero(y_train)
ham_train_pct = int(100*ham_train/y_train.shape[0])
ham_test = np.count_nonzero(y_test)
ham_test_pct = int(100*ham_train/y_test.shape[0])

print("Train/test split created.\nTraining on {} samples, ({}% ham & {}% spam)\nTesting on {} samples, ({}% ham & {}% spam)".format(y_train.shape[0], ham_train_pct, 100-ham_train_pct, y_test.shape[0],ham_train_pct, 100-ham_train_pct))
...
print("Prediction f1 score: ", f1_score(y_test, prediction))